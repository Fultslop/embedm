...
from embedm_plugins.text_processing import _clean_text
...
def test_clean_text_preserves_snake_case_identifier() -> None:
    result = _clean_text("Refactor plugin_resources.py into file_resources.")
...
def test_clean_text_preserves_upper_snake_case_constant() -> None:
    result = _clean_text("Registered in DEFAULT_PLUGIN_SEQUENCE after synopsis.")
